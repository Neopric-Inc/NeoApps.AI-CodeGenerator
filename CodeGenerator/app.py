...
with tab2:
    ...
    with st.form(key='frontend_form'):
        ...
        database_name = st.text_input("Database Name", "splitthebill", key='frontend_database_name')
        script = st.text_input("Script URL", "http://localhost/split_app_script.sql", key='frontend_script')
