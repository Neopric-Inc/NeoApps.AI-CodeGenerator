    ...
    return (
        <div id="menu-wrapper" className="control-section">
            <div id="sidebarmenu">
                ...
                <SidebarComponent id="menuSidebar" className="sidebar-menu" ref={Sidebar => (sidebarobj as any) = Sidebar} enableDock={enableDock} dockSize={dockSize} width={width} target={target} isOpen={true} type="Over">
